...
const DonationRole         = "746762474585325629";
...
const ChallengesChannel    = "756558286198931536";
...
//Follower Badge
if  (message.webhookID && message.reference && message.reference.guildID == SupportServer && message.reference.channelID == AnnouncementsChannel && message.guild.owner)  {
